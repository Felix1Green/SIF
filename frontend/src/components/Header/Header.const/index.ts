...
export const headerNavigationLinkCn = cnHeader('Navigation__Link');
export const headerUserContainerCn = cnHeader('UserContainer');
export const headerAuthCn = cnHeader('Auth');
